---
name: copywriting-prospection
type: prompt-skill
squad: prospection
inputs: [lead_data, canal]
outputs: [mensagem_wa, mensagem_li, mensagem_email]
playbooks_recomendados: [templates-mensagens-prospection, sinais-de-dor-digital]
---

# Skill: Copywriting de prospection

Gera mensagens personalizadas para WhatsApp, LinkedIn e E-mail baseadas nos dados do lead.

## Como Invocar

Aplique copywriting-prospection para lead [NOME], segmento [SEGMENTO], cidade [CIDADE], dor [DOR], canal [CANAL]
