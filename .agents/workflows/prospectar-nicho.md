---
description: >
  Executa o ciclo completo de prospeccao para um nicho e cidade especificos.
...
Salvar em: PROJETOS/_prospeccao/leads-brutos/[CIDADE]-[NICHO]-[DATA].json
...
Template: templates/template-relatorio-prospeccao.md
